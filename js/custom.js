...
// Récupérer l'élément bouton et le paragraphe
const webcamButton = document.getElementById('webcamButton');
const paragraph = document.querySelector('.heading1 p');

// Ajouter un événement de clic au bouton
webcamButton.addEventListener('click', () => {
  // Changer la propriété CSS "display" pour masquer le paragraphe
