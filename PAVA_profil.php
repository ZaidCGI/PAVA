...
<head>
    ...
    <!-- site metas -->
    <title>Profile utilisateur Pava</title>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="full dis_flex center_text">
                                                    ...
                                                    <div class="profile_contant">
                                                        <h3 class="mb-2"><?php echo $_SESSION['email']?></h3>
                                                        <ul class="list-unstyled profile">
                                                            ...
                                                            <li><i class="fa fa-key"></i> Date d'expiration : <?php 
                                                                // Définir le fuseau horaire
                                                                date_default_timezone_set('Europe/Paris');

                                                                // Format de date jour mois année
                                                                $dateExpiration = date('d/m/Y', $_SESSION['expire']);
                                                                echo $date;
