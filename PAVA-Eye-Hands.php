               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><a href="index1.html"><img class="img-responsive" src="images/layout_img/user_img.jpg" alt="#" /> </a></div>
                        <div class="user_info">
                           <h6>PAVA.</h6>
                        ...
                        <div class="col-md-12">
                           <div class="white_shd full margin_bottom_30 ">
                              <div class="full graph_head">
                                 <p >
                                    PAVA.eye Hands est un outil de détection visuelle qui permet de reconnaître automatiquement vos mains. <br>
                                    Il affiche chaque phalange sous la forme d'un point rouge relié par des traits verts à chaque autre point rouge correspondant. 
                                 </p>
                              </div>
